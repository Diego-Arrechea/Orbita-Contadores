...
/**
 * Toasts transitorios que avisan cuando una re-sincronización manual (el botón "Actualizar" de un
 * cliente en la lista) termina. Aparecen abajo a la derecha y se van solos a los 5 s (lógica en
 * SyncManualContext). Se montan una vez, por encima del router (ver App.tsx).
 */
export function SyncManualToasts() {
  const { avisos, descartarAviso } = useSyncManual();
